...
class TestBotApp(unittest.TestCase):
    ...
    def test_postImages(self):
        ...
        testBot.post_images_FS() #THEN the bot should save images from the group to the imgs folder
    ...
    def test_getImages(self):
        ...
        testBot = bot.Bot(os.environ['bot_id'], os.environ['token'], os.environ['group_ID'])
        imageList = testBot.post_images_FS() #AND THEN post_images calls the private get_images method which returns an array
